...
async function updateCounter() {
  try {
    let response = await fetch("https://aydfnwwubjtsw65yb36umqoyxi0agwab.lambda-url.us-east-1.on.aws/");
    ...
    // Assuming the Lambda function returns an object with a "views" property
    const views = data.views;
    
    // Update the HTML element with the "views" data
